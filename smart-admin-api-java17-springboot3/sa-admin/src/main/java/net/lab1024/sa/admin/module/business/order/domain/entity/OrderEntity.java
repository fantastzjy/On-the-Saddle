...
public class OrderEntity {
    ...
    @DataTracerFieldLabel("被服务会员ID")
    private Long selectedMemberId;

    @DataTracerFieldLabel("被服务会员编号")
    private String selectedMemberNo;

    @DataTracerFieldLabel("被服务会员姓名")
    private String selectedMemberName;

    @DataTracerFieldLabel("被服务会员手机号")
    private String selectedMemberPhone;

    @DataTracerFieldLabel("是否为监护人购买")
    private Boolean isGuardianPurchase;

    @DataTracerFieldLabel("订单来源")
